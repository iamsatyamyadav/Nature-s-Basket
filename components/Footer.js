function Footer(){
    return`        <div id="upper_box">
    <div id="upper_InnerBox">
        <div id="DOWNLOAD_THE_APP">
            <h3>DOWNLOAD THE APP</h3>
            <a href="https://play.google.com/store/games">
                <img src="	https://cdn.worldvectorlogo.com/logos/get-it-on-google-play.svg" alt="">
            </a>
            <a href="https://www.apple.com/in/">
                <img src="	https://cdn.worldvectorlogo.com/logos/available-on-the-app-store.svg" alt="">
            </a>
        </div>
        <div id="About_us">
            <h3>ABOUT US</h3>
    ...
    <div id="paymant_apps">
        ...
        <p id="p_sy">Keep in Touch</p>
        <img id="img_2_sy" src="https://www.naturesbasket.co.in/Images/footer-social.png" alt="">
    </div>
  
    <hr>
</div>
<div id="Lower_box">
    <div id="Lower_InnerBox">
        <div id="FRESH_FAST">
            <h3>FRESH & FAST</h3>

            <h3 id="Yu_hi">GIFT HAMPERS</h3>
      ...
      <a href="">
        ...
        <p>Cheese Spread, Slices & Other</p>
    </a>
        </div>
        <div id="INTERNATIONAL_CUISINE">
        ...
        <div id="CONFECTIONARY_PATISSERIE">
        ...
        <div id="SNACKS_BEVERAGES">
            ...
            <a href="">
             ...
             <a href="">
                ...
                <p>Energy Drinks & Milk Additives</p>
            </a> 
            </a>  <a href="">
                <p>Juice</p>
            </a> 
